			...
			<div class="row">
						...
						<div class="col-md-9 ">
								<div class="form-group form-group-sm">
									...
									<p>Have you read and accepted the <a href="terms.php">TERMS AND CONDITIONS</a> and Your information will be held securely 
									with our data protection and management policy</p>
								</div>
							</div>
