			  ...
			  <div class="row">
						...
						<div class="row">
							...
							<div class="col-md-8 col-md-offset-2">
								<div class="form-group form-group-sm">
									<input name="fName" class="form-control"  type="text" value="Enter Customer Name ">
								</div>
							</div>
				...
				<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="form-group form-group-sm">
									<span class="essential">*</span><label>Reciever Phone</label>
						...
						<div class="row">
							...
							<div class="col-md-5 col-md-offset-3">
								<div class="form-group form-group-sm">
									...
									<select name="bank" id="abank" class="form-control"  type="text">
									<?php foreach($bank_a as $banka):?><option><?php echo $banka->bank;  ?></option><?php endforeach; ?>
									</select>
									
									<select name="bank" id="pbank" class="form-control"  type="text">
