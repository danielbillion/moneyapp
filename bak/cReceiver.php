...
$template->rate=$trans->todaysrate();
		...
		if(isset($_POST['submit'])){
					...
					$listArray=array();
						...
						$required=array('fName','lName','rPhone','bank','modeId');	
						}
						else{
							$required=array('fName','lName','rPhone','bank','actNo');
						}
	...
	// insert new record here
							if($receiver->insert($listArray)){
								
								redirect('sendersReceivers.php','New Receiver Has Been Created ','success');
							}
							else{
	...
	//update else
		...
		//for updating existing receiver or agent cust receiver records
