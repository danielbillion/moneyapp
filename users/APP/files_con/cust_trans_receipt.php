...
<?php if (isset($web1)){ echo $web1; }  ?>
              ...
              <tr>
                ...
                <td width="180" class="style10" style="font-size: 14px"><span class="style12">NAME:</span></td>
    ...
    if(isset($s_phone)){  // Check if $msg is not empty  
		...
		echo strtoupper ($s_phone);} ?></span></div></td>
              ...
              <tr>
                <th rowspan="2" style="font-size: 14px" scope="row"><div align="left"><span class="style12">TOTAL PAYMENT:</span></div></th>
                <td rowspan="2" class="style13" style="font-size: 14px"><span class="style12"><span class="style7">&pound; </span>
			...
			document.write('<form><input type=button name=print value="Print" onClick="window.print()"></form>');
              ...
              <tr>
                ...
                <th height="37" colspan="4" scope="row"><div align="right"><a href="customer_page.php" class="style14">Return to  home page</a></div></th>
              </tr>
            </table>
          </div></th>
        </tr>
