...
<?php if (isset($web1)){ echo $web1; }  ?>
              ...
              <tr>
                ...
                <td width="103" class="style10" style="font-size: 14px"><div align="right" class="style12"></div></td>
                <td width="97" class="style10" style="font-size: 14px"><span class="style12">NAME:</span></td>
    ...
    if(isset($s_phone)){  // Check if $msg is not empty  
		...
		echo strtoupper ($s_phone);} ?></span></div></td>
              ...
              <tr>
                ...
                <td colspan="2" class="style10" style="font-size: 14px"><div align="center"><span class="style12"><span class="style12">BANK PAYING:</span></span></div></td>
                <td class="style10" style="font-size: 14px"><span class="style12">
              ...
              <tr>
               ...
               <td colspan="2" class="style10" style="font-size: 14px"><div align="center" class="style12">TRANSFER MODE:</div></td>
               <td class="style10" style="font-size: 14px"><span class="style12">
              ...
              <tr>
                ...
                <td colspan="2" class="style13" style="font-size: 14px"><div align="center" class="style12">MODE OF IDENTITY:</div></td>
              ...
              <tr>
                ...
                <td colspan="2" class="style13" style="font-size: 14px"><div align="center" class="style12">ACCOUNT NUMBER:</div></td>
                <td class="style13" style="font-size: 14px"><span class="style12">
			...
			document.write('<form><input type=button name=print value="Print" onClick="window.print()"></form>');
              ...
              <tr>
                ...
                <th height="37" colspan="4" scope="row"><div align="right"><a href="admin_page.php" class="style14">Return to  home page</a></div></th>
              </tr>
            </table>
          </div></th>
        </tr>
...
' > Cancel  </a></em>"; ?></span></td>
    <td width="73">&nbsp;</td>
    <td width="168"><span style="font-size: 14px"><?php echo "</td><td>";echo "<em><a href='admin_cust_task.php?r_name=$r_name & s_fname=$s_fname & r_transfer=$r_transfer  & r_amtsend= $r_amtsend & r_amtlocal= $r_amtlocal  & r_total=$r_total & receiptno=$receiptno  & age_email= $age_email & s_email= $s_email & date=$date '> Task	</a></em>";  ?></span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
