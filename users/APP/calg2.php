...
while ($row = mysql_fetch_assoc($result)) {
 ...
 include "conn.php"; 
		...
		$result = mysql_query('SELECT id,rate,nu FROM todays_rate
...
if($md == "nu"){
		...
		$lc=($mon * $er ); $ap=($mon + $tf); 
		echo nl2br("Summary");echo nl2br("<hr>"); echo " Amount to be Sent  (₦):"; echo ($mon);echo "<p></p>";echo "<p></p>";
		echo "<p></p>"; echo " Local Payment (Naira):"; echo ($tr);
		 echo "<p></p>";
		...
		$lc=($mon * $er ); $ap=($mon + $tf); 
		 echo nl2br("Summary");echo nl2br("<hr>"); echo " Amount to be Sent  (₦):"; echo ($mon);echo "<p></p>";
			echo "<p></p>"; echo "<p></p>"; echo " Local Payment (Naira):"; echo ($tr);
					 echo "<p></p>";
		...
		$lc=($mon * $er ); $ap=($mon + $tf); 
			echo " Amount to be Sent  (₦):"; echo ($mon);echo "<p></p>"; echo "<p></p>";
			echo "<p></p>"; echo " Local Payment (Naira):"; echo ($tr);echo "<p></p>";
