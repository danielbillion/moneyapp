...
<?php 
 ...
 $check = mysql_query("SELECT username FROM daphkkoy WHERE username = '$usercheck'") 
...
// here we encrypt the password and add slashes if needed
 ...
 // now we insert it into the database
 	...
 	$insert = "INSERT INTO daphkkoy (username, password)
 ...
 <tr><td><p align="center" class="style1">Kunzle Setup </p>
</td><td>
