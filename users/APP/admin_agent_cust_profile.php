...
.style27 {font-size: 10px; font-style: italic; }
-->
</style>
</head>
          ...
          <th width="599" height="479" scope="row"><div align="center">
            <table width="584" height="635" border="0" cellpadding="0" cellspacing="0">
              <tr bgcolor="#9933CC">
                ...
                <th bgcolor="#CCCCCC" scope="row"><a href="admin_page.php" class="style27">Return to administration home page</a></th>
              </tr>
              <tr>
              ...
              <tr>
                <th colspan="5" scope="row"><div align="right" class="style8">
                    <div align="center"><span class="style23"><strong>Customer Name </strong> =&gt;<span class="style24"></span> <?PHP  if (isset($_GET['fname']))
				...
				?>
                    </span><span class="style26">of Agent Name: <?php include "conn.php"; 
					$ag_email=$_GET['ag_email'];
					 $checkagent = mysql_query("SELECT * FROM agent WHERE email='$ag_email' ORDER BY lname DESC") or die('Query failed: ' . mysql_error());
					 while($rag=mysql_fetch_array($checkagent)){
						 
						 echo $rag['fname'],"  ",$rag['lname'];
					 }
              ...
              <tr>
                ...
                <td width="49" class="style10">&nbsp;</td>
                <td width="143" class="style10">&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="4" class="style10"><div align="left" class="style20">
                    <?PHP  if (isset($_GET['c_ag_email']))
				
				echo  ($_GET['c_ag_email']);
...
echo "
<em><a href='agent_cust_proofad_download.php? c_ag_email=$c_ag_email '> download</a></em>";
...
echo "
<em><a href='agent_cust_proofid_download.php? c_ag_email=$c_ag_email '> download</a></em>";
