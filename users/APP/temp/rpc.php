...
//echo "<a href='agent_quick.php?b_lname=$b_lname &b_fname=$b_fname & r_name=$r_name & custe=$custe'><li onClick='fill(\''.ucfirst($resultr->b_fname).'\');'>".strtolower($result4). ' '.strtolower($result5).'</li></a>';
		...
		echo " <align='center'><u><font size='2'> Customer </font></u></align>";
				if($query) {
					while ($result = $query ->fetch_object()) {
						...
						$results=$result->fname;
						$resultd=$result->lname;
						
						
					echo "<a href='agent_cust_search.php?info=$resultd'><li onClick='fill(\''.ucfirst($result->fname).'\');'>".strtolower($resultd). ' '.strtolower($results).'</li></a>';
...
//echo "<a href='agent_quick.php?b_lname=$b_lname &b_fname=$b_fname &r_name=$r_name & custe=$custe'><li onClick='fill(\''.ucfirst($resultr2->b_fname).'\');'>".strtolower($result6). ' '.strtolower($result7).'</li></a>';
