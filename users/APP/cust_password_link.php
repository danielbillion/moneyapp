...
<body>
	...
	<!-- start wrap div -->
	<div id="wrap"><a href="cust_change_password_reset.php?email_f=<?php  echo $_GET['email_f']; ?>&id=<?php  echo $_GET['id']; ?>">CLICK HERE TO RESET TO A NEW PASSWORD For <?php session_start(); echo $_GET['email_f'];  ?></a></div>
	<!-- end wrap div -->
</body>
</html>
<?php 
