...
<caption><EM><span style="font-weight:bold; color:blue;">Recycle Customer</span></EM></caption>
...
$link = include "conn.php";
 include "conn.php";  
 $check = mysql_query("SELECT * FROM new_customer_cancel ORDER BY lname DESC") or die('Query failed: ' . mysql_error());
 $check1 = mysql_query("SELECT * FROM new_customer_cancel ")or die(mysql_error());
...
echo "</td><td align='left'>";echo "<em><a href='admin_restore.php?fname=$fname & ag_email=$ag_email & cust_re=$cust_re '> Restore  </a></em>";
