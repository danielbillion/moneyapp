          ...
          <table width="604" height="247" border="0">
              <tr bgcolor="#9900FF">
                <td width="655" nowrap="nowrap" bgcolor="#CCCCCC">
                  <p align="center" class="style13"><u><span ">MODIFY EXISTING RECEIVER</span><span class="style17"> 
...
<?php 
												//if( $_SERVER['REQUEST_METHOD'] == 'POST' 
														...
														$date=date("Y-m-d");
															...
															mysql_query("UPDATE receiver SET b_phone = '$b_phone', b_idtype = '$b_idtype' , b_transfer='$b_transfer' 
															 , b_pbank = '$b_pbank', b_abank = '$b_abank', b_actno = '$b_actno' 
															 
															 WHERE b_fname = '$r_fname' && b_lname='$r_lname' ");
...
window.location='customer_page.php';
                      ...
                      <tr>
                        <td>First Name</td>
                        <td colspan="2"><input name="b_fname" type="text" id="b_fname"  readonly="readonly" value=
                      ...
                      <tr>
                        ...
                        <td colspan="2"><label>
                          ...
                          <div align="left">
                            <input name="b_lname" type="text" id="b_lname"  readonly="readonly"  value=
...
?></div></td>
					  ...
					  <tr>
					    ...
					    <td><select name="b_transfer" id="b_transfer" onChange="toggleMe(this.value)">
					      <option> <?php
						 $r_transfer = ($_GET['r_transfer']); // Set email variable

						 if (isset($_GET['r_transfer']))
						{ echo  ($r_transfer);} ?></option>
					  ...
					  <tr>
					    <td>&nbsp;</td>
					    <td width="359"><div align="left"></div></td>
					    <td width="33">&nbsp;</td>
					    <td>&nbsp;</td>
					    <td colspan="2">
					      <div align="left"></div>
