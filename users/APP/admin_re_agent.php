...
<caption><EM><span style="font-weight:bold; color:blue;">Recycle Agent</span></EM></caption>
...
$link = include "conn.php";
 include "conn.php";  
 $check = mysql_query("SELECT * FROM agent_cancel ORDER BY lname DESC") or die('Query failed: ' . mysql_error());
 $check1 = mysql_query("SELECT * FROM agent_cancel ")or die(mysql_error());
...
echo "</td><td align='left'>";echo "<em><a href='admin_restore.php?fname=$fname & ag_email=$ag_email & ag_re=$ag_re '> Restore  </a></em>";
//echo "</td><td align='left'>";echo "<em><a href='admin_restore.php?fname=$fname &lname=$lname & ag_email=$ag_email & ag_del=$ag_del '> Restore  </a></em>";
