    ...
    <table width="395" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <th height="31" valign="bottom" bgcolor="#339933" scope="row"><span class="style5">
          ...
          <div align="right">&nbsp;</div>          
          <span style="font-size: 14px"><strong style="color: #FFF; font-size: 18px;"><u>Your Online Customer Turnover</u></strong></span></th>
      </tr>
    </table>
  </form>
...
echo "</td><td align='center'>";echo number_format($row['amtsend'],2);

//$money='$'.round($row['amtsend']/100,2);
...
// $check1 = mysql_query("SELECT * FROM cust_transaction WHERE agent_email = '$email'")or die(mysql_error());
 $check1= mysql_query("SELECT * FROM cust_transaction WHERE sender_name = '$_POST[txt]' && agent_email = '$email' ")or die(mysql_error());
