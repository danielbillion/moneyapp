...
//$email= ($_SESSION['email']);
$c_email = ($_GET['ag_email']); // Set email variable
 
 include "conn.php"; 
 
   $check = mysql_query("SELECT * FROM agent") or die('Query failed: ' . mysql_error());
 $check0 = mysql_query("SELECT * FROM agent WHERE email ='".$c_email."'")or die(mysql_error());
...
die();
	...
	*/
	...
	mysql_query("UPDATE agent SET pnumber = '$n_pnumber', mnumber = '$n_mnumber', fname = '$fname2', lname = '$lname2', mname = '$mname2', dob = '$dob',address = '$add',postcode = '$postcode', email='$n_email' 
        ...
        <td><table width="558" height="407" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          ...
          <tr>
            ...
            <th scope="row"><label><span class="style20">
              <input name="textfield7" type="text" value="" readonly="readonly" />
            </span></label></th>
            <th scope="row">&nbsp;</th>
          ...
          <tr>
            ...
            <th scope="row"><input type="text" name="n_email" value="<?php if (isset($email)) { echo ($email);} ?>" size="0" /></th>
            <th scope="row">&nbsp;</th>
            <th colspan="3" scope="row"><span class="style23">Date of Birth</span>              <input type="text" name="dob" value="<?php if (isset($dob)) { echo strtoupper($dob);} ?>"/></th>
            </tr>
          <tr>
            <th scope="row"><span class="style24"></span></th>
            <th colspan="5" scope="row">&nbsp;</th>
