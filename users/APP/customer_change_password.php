    ...
    <td height="168"> <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <div align="center"></div>
            ...
            <table width="319" height="329" border="2" align="center" bordercolor="#000099">
              <tr>
                <td height="33" valign="top"><div align="center">Email</div></td>
                <td width="149" valign="top"><input name="email" type="text" id="email" /></td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="52"><div align="center">New Email </div></td>
                <td><label>
...
<?php 
 ...
 if (!$_POST['email'] | !$_POST['pass'] | !$_POST['pass1'] | !$_POST['pass2'] | !$_POST['user_new']) {
 ...
 if ($check2 == 0) {
	...
	//mysql_query("UPDATE new_customer SET email ='$usercheck'
//WHERE email ='$usercheck'");
...
$usercheck = $_POST['user_new'];
 ...
 $check = mysql_query("SELECT email FROM new_customer WHERE email = '$usercheck'") 
...
mysql_query("UPDATE new_customer SET email = '$use2' WHERE password = '$pass' ");
		
echo "<script>alert(\"Thank you,your new email and password has been updated.\");</script>";


 echo("Thank you,your new email and password has been updated.");
