		...
		if( $_SERVER['REQUEST_METHOD'] == 'POST' )
{
 ...
 $check3 = mysql_query("SELECT * FROM cust_transaction  ")or die(mysql_error());
// $check1 = mysql_query("SELECT * FROM cust_transaction WHERE sender_email = '$email'")or die(mysql_error());
 $check1= mysql_query("SELECT * FROM cust_transaction WHERE sender_name = '$_POST[txt]' && sender_email = '$email' ")or die(mysql_error());
...
$table_array = mysql_fetch_array($check);
 ...
 include "info.php";
if(($bs_mtls=='1')){	 
  $check= mysql_query("SELECT * FROM cust_transaction WHERE `amt_send` <= $bs_mtl AND sender_name = '$_POST[txt]' && sender_email = '$email' ")or die(mysql_error());
}

if(($bs_mtls=='0')){	 
  $check= mysql_query("SELECT * FROM cust_transaction WHERE sender_name = '$_POST[txt]' && sender_email = '$email' ")or die(mysql_error());
}
include "search_proc_cust.php";
 ...
 if($search=="rn"){
  include "info.php";
if(($bs_mtls=='1')){
 $check= mysql_query("SELECT * FROM cust_transaction WHERE `amt_send` <= $bs_mtl AND receiptno = '$_POST[txt]' && sender_email = '$email' ")or die(mysql_error());}
 
 if(($bs_mtls=='0')){
 $check= mysql_query("SELECT * FROM cust_transaction WHERE  receiptno = '$_POST[txt]' && sender_email = '$email' ")or die(mysql_error());}
include "search_proc_cust.php";
 ...
 include "info.php";
if(($bs_mtls=='1')){	 
 $check= mysql_query("SELECT * FROM cust_transaction WHERE  `amt_send` <= $bs_mtl AND  date = '$value' && sender_email = '$email' ")or die(mysql_error());}
 
 if(($bs_mtls=='0')){	 
 $check= mysql_query("SELECT * FROM cust_transaction WHERE  date = '$value' && sender_email = '$email' ")or die(mysql_error());}
include "search_proc_cust.php";
 };
  ...
  if($search=="bd"){
	...
	if(($bs_mtls=='1')){	 
 $check= mysql_query("SELECT * FROM cust_transaction WHERE `amt_send` <= $bs_mtl AND STR_TO_DATE(date, '%Y-%m-%d') BETWEEN '$ts1' AND '$ts2' && sender_email = '$email' ")or die(mysql_error());}

	if(($bs_mtls=='0')){	 
 $check= mysql_query("SELECT * FROM cust_transaction WHERE STR_TO_DATE(date, '%Y-%m-%d') BETWEEN '$ts1' AND '$ts2' && sender_email = '$email' ")or die(mysql_error());}
 include "search_proc_cust.php";
