...
<table width="611" height="249" border="0" align="center">
  <tr>
    <td width="462" height="50"><table width="246" border="0" align="center" bgcolor="#990099">
      <tr>
        <td width="240"><div align="center" class="style1">Agent Password Modification </div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
<?php 
 ...
 $check = mysql_query("SELECT * FROM agent_log WHERE username = '".$_POST['username']."'")or die(mysql_error());
...
$_POST['pass'] = md5($_POST['pass2']);
 ...
 mysql_query("UPDATE agent_log SET password = '$pass'
WHERE username = '$use' ");
...
or die(mysql_error());
 ...
 if ($check2 != 0) {
		...
		header("Location: agent_password_change.php");
