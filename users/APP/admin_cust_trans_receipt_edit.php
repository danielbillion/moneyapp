    ...
    if(isset($s_phone)){  // Check if $msg is not empty  
		...
		echo strtoupper ($s_phone);} ?>
          ...
          <tr>
            ...
            <td colspan="4" class="style10" style="font-size: 14px"><div align="center" class="style12">
              <div align="left"><u style="font-size: 18px; font-weight: bold;">MODE OF PAYMENT</u></div>
            </div></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <th height="37" colspan="5" scope="row"><div align="right"><a href="Admin_page.php" class="style14">Return to Admin home page</a></div></th>
          </tr>s
        </table>
      </form>
    </div></th>
