...
<title>Delete / Suspend Agent </title>
<style type="text/css">
<!--
.style1 {
	color: #0000CC;
...
<caption><EM>Cancel / Suspend  Agent</EM></caption>
...
$link = include "conn.php";
 include "conn.php";  
 $check = mysql_query("SELECT * FROM agent ORDER BY lname DESC") or die('Query failed: ' . mysql_error());
 $check1 = mysql_query("SELECT * FROM agent ")or die(mysql_error());
...
echo "</td><td align='left'>";echo "<em><a href='admin_agent_profile_task.php?fname=$fname &lname=$lname & ag_email=$ag_email & ag_del=$ag_del '>  $view  </a></em>";


echo "</td><td align='left'>";echo "<em><a href='admin_pay_agent.php?fname=$fname & ag_email=$ag_email & ag_del=$ag_del '> Cancel  </a></em>";
