...
<?php
	...
	if ( isset($_POST['Submit']) ){
		...
		mysql_query("INSERT INTO bank (status,bank)
...
window.location='admin_bank.php';
 }
</script> ";
  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="">
      <table width="517" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="149" style="text-align: right"><div align="left"></div></td>
          <td width="178"><input type="radio" name="dbank" id="dbank" value="p" />
Pick Up</td>
...
$link = include "conn.php";
 include "conn.php";  
 $check = mysql_query("SELECT * FROM bank ORDER BY bank") or die('Query failed: ' . mysql_error());
