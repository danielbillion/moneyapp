...
<body><br />
<div><span class="button"><a href="agent_page.php">Home</a></span> <span class="button"><a href="agent_new_customer_reg.php">New Sender</a> </span></div>
<span style="margin-left:17em; color:blue;"><strong> 1.) ENTER SENDER NAME & CLICK OPTION 2.) CHOOSE & SELECT    RECEIVER  3.) ENTER AMOUNT 4.) CONFIRM</strong> </span>
<div id="container2">
...
<div style="color:black"><STRONG>SEARCH FOR SENDER</STRONG><span style="margin-left:22em;"><STRONG>ADDRESS </STRONG></span></div><br/>

<div style="margin-left:3em; color: #0000;">
        
       * <input type="text" id="sv" name="sv"  onFocus="this.value=''" onBlur="fill();" onKeyUp="lookup(this.value);" placeholder=" RECEIVER FIRST NAME"  
...
<div style="margin-left:3em; color:#000000">£ <input type="text" name="mon" onFocus="this.value=''" onBlur="fill();" onKeyUp="lookcal(this.value);"  placeholder="AMOUNT TO SENDR" /></div>
