...
<body>
	<!-- start header div -->
	<div id="header">
		<h3><?php include "info.php"; echo $name1;  ?> > Forgot Password for <strong>customer</strong></h3>
...
include "info.php"; 
 $email_f=$_POST['email_forgot'];
  ...
  if(!$_POST['email'] ) {
	 	...
	 	$check_email = mysql_query("SELECT * FROM new_customer WHERE email = '$email_f'")or die(mysql_error());
...
$email_f=$_POST['email_forgot'];
$address="https://".$web1."/app/cust_password_link.php?email_f=$email_f&id=$id";
