...
<div align="center">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="796" height="302" border="0" cellpadding="0" cellspacing="0">
    
    <tr>
      <th width="796" height="31" scope="row"><table width="670" height="192" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          <th colspan="2" scope="row"><span class="style18">Our Bank Details </span>
            <hr /></th>
          </tr>
        <tr>
          <th width="358" height="38" scope="row"><p class="style19">&nbsp;</p>
            <p class="style19"><?php 		
 include "conn.php";	 
...
while ($row = mysql_fetch_assoc($result)) { echo $row['bank2'];} 
  ?>
          ...
          <th width="312" rowspan="2" scope="row"><span class="style19"><img src="mny.jpg" width="106" height="100" /></span></th>
        </tr>
        <tr>
          <th height="76" scope="row"><p class="style20">OR Call our office to get <?php include "info.php"; echo $name1;  ?> Bank Account details</p>
