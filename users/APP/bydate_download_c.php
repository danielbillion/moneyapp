...
<div id="header">  
  <blockquote>
    ...
    <tr>
      <th colspan="2" class="style10" scope="row"><table width="638" border="0" cellspacing="0" cellpadding="0">
        <tr>
        ...
        <tr>
          ...
          <th class="style31" scope="row">Agent</th>
          </tr>
        <tr>
...
location='bydate_proc_download_c.php';
 }
</script> ";
