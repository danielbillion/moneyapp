...
<?php include 'includes/header.php'; ?>
  ...
  <script>
	...
	function findval(val){
		...
		$.post("sendMoney.php",{myoption:""+$("[name='option']:checked").val()+"",exval:""+val+""},function(data){
			...
			<?php if(getUser()['type']=='agent'): ?>
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						...
						<select name="senders"  id="senders" class="form-control" onchange="fetch_receiver(this.value);" placeholder="Senders">
						<option selected>Please Select Sender</option>
						<?php foreach($senders as $senders):?>
						<option><?php echo $senders->fname." ".$senders->lname." ".$senders->mname ; ?></option>
						<?php endforeach; ?>
						</select>
						</div>
					</div>
					...
					<div class="well">
						<div class="row">
							<div class="col-md-4 col-md-offset-1">
								...
								<input name="rFName" id="rFName" type="text" class="form-control" readonly placeholder="Sender Name">
								</div>
							</div>
							<div class="col-md-4 col-md-offset-1">
								<div class="form-group form-group-sm">
						...
						<div class="row">
							<div class="col-md-4 col-md-offset-1">
								...
								<input name="rPhone" id="rPhone" type="text" class="form-control" readonly placeholder="Sender Name">
								</div>
							</div>
							<div class="col-md-4 col-md-offset-1">
								<div class="form-group form-group-sm">
						...
						<div class="row">
							<div class="col-md-4 col-md-offset-1">
								...
								<input name="rBank" id="rBank" type="text" readonly class="form-control" placeholder="Sender Name">
								</div>
							</div>
							<div class="col-md-4 col-md-offset-1">
								<div class="form-group form-group-sm">
								<label>Receiver Acct No</label>
								<input id="rActno" name="rActno" type="text" readonly  class="form-control" placeholder="Sender Name">
								</div>
							</div>
					</div>
				</div>
				<!-----Amount to Send And Calculator Starts here---->
				<div class="row">
