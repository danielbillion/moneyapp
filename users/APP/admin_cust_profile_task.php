...
<title>Status Modification</title>
<style type='text/css'>
<!--
.style7 {color: #0000FF}
      ...
      <table width="200" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <th scope="row"><table width="476" height="461" border="0" cellpadding="0" cellspacing="0">
            <tr bgcolor="#999999">
              <th height="19" colspan="4" bgcolor="#CCCCCC" scope="row">Customer Status </th>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="style10"><div align="center" class="style13">
                  <div align="left" class="style15">
                    <div align="center">Customer  Name </div>
                  </div>
              </div></td>
              <td class="style15"><?PHP  if (isset($_GET['fname']))
            ...
            <tr>
              ...
              <td class="style10"><div align="left" class="style15"> <span class="style7">
...
$link = include "conn.php";
 ...
 mysql_query("UPDATE new_customer SET active = '$status' WHERE email = '$ag_email' ") or die( "<b>Error:</b> Something went wrong, could not edit link status.");

echo" <script type='text/javascript'>
 
 {
 window.alert('Your Customer status now been Successful Modiified')
