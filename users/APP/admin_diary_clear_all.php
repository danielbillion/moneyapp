      ...
      <table width="200" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <th scope="row"><table width="476" height="282" border="0" cellpadding="0" cellspacing="0">
            <tr bgcolor="#999999">
              <th height="19" colspan="4" bgcolor="#000000" scope="row"><span style="color: #FFF">Customer Diary</span>y<span style="font-style: italic; color: #FFF;">- CLEAR All!</span></th>
            </tr>
            <tr>
...
//$link = include "conn.php";
 ...
 mysql_query("UPDATE diary_cust SET status = 'cl' WHERE email = '$email' ") or die( "<b>Error:</b> Something went wrong, could not edit link status.");
