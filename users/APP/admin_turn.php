    ...
    <table width="395" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <th height="31" valign="bottom" bgcolor="#339933" scope="row"><span class="style5">
          ...
          <div align="right">&nbsp;</div>          
          <span style="font-size: 14px"><strong style="color: #FFF; font-size: 18px;"><u>Your AgentsTurnover</u></strong></span></th>
      </tr>
    </table>
  </form>
...
WHERE  (status = ' Pending' || status = 'Pending' || status='PAID') && date
