...
SELECT id,date,receiptno,sender_name,r_name,r_transfer,amt_send,amt_local,com_d,com_a,total,status FROM cust_transaction WHERE STR_TO_DATE(date, '%Y-%m-%d') BETWEEN '$ts3' AND '$ts4'");
