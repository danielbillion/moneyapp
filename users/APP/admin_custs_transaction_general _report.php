...
$start_from = ($page-1) * 20;
 ...
 include "info.php";
if(($bs_mtls=='1')){
$check = mysql_query("SELECT * FROM cust_transaction WHERE `amt_send` <= $bs_mtl  ORDER BY date DESC LIMIT $start_from, 20") or die('Query failed: ' . mysql_error());
}

if(($bs_mtls=='0')){
$check = mysql_query("SELECT * FROM cust_transaction ORDER BY date DESC LIMIT $start_from, 20") or die('Query failed: ' . mysql_error());
}
...
$sql = "SELECT COUNT(id) FROM cust_transaction"; 
