...
<caption><EM>Email To Customer</EM></caption>
...
$link = include "conn.php";
 ...
 $checkda = mysql_query("SELECT * FROM cust_transaction ")or die(mysql_error());
 $checkts = mysql_query("SELECT * FROM new_customer ")or die(mysql_error());
...
echo "</td><td align='center'>";echo "<em><a href='#?fname=$fname & lname=$lname & ag_email=$ag_email & dob=$dob & mnum=$mnum & pnum=$pnum & address=$address & postcode= $postcode '> Email Customer </a></em>";
...
echo "</td><td colspan='7' align='center'>";echo "  Send To All  Customers ";
