...
$check2 = mysql_query("SELECT * FROM agent_cust_transaction WHERE agent_email = '$email'")or die(mysql_error());
$total_lc=0;
...
$check3c = mysql_query("SELECT * FROM agent_cust_transaction WHERE agent_email = '$email'")or die(mysql_error());
$total_comc=0;
...
$check4 = mysql_query("SELECT * FROM agent_cust_transaction WHERE agent_email = '$email' && clear='uc' ")or die(mysql_error());
$total_t=0;
...
$sql = "SELECT COUNT(id) FROM agent_cust_transaction WHERE agent_email = '".$email." ' && STR_TO_DATE(date, '%Y-%m-%d') BETWEEN '$ts2' AND '$ts1'"; 
