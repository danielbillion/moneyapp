...
die();
	...
	*/
	...
	mysql_query("UPDATE agent_new_customer SET pnumber = '$n_pnumber', mnumber = '$n_mnumber', fname = '$fname2', lname = '$lname2', mname = '$mname2', dob = '$dob',address = '$add',postcode = '$postcode', email='$n_email'
    ...
    <th width="568" height="395" scope="row"><form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width="558" height="407" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr>
          ...
          <th width="210" scope="row"><input type="text" name="fname"  value="<?php if (isset($fname)) { echo strtoupper($fname);} ?>" "/></th>
        ...
        <tr>
          ...
          <th scope="row"><div align="left"><input type="text" name="mname" value="<?php if (isset($mname)) { echo strtoupper($mname);} ?>" "/></div></th>
          <th scope="row">&nbsp;</th>
          <th scope="row"><span class="style23">Date of Birth</span></th>
          <th scope="row"><input type="text" name="dob" value="<?php if (isset($dob)) { echo strtoupper($dob);} ?>"/>
