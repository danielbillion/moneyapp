...
//mysql_query("UPDATE agent_cust_transaction SET r_name = '$rname', r_phone = '$rphone' ,r_transfer = '$tmode',r_bank=$bank ,r_actno = '$ractno'  
//WHERE  receiptno='$code' ");

mysql_query("UPDATE agent_cust_transaction SET r_name = '$rname', r_phone = '$rphone',r_actno = '$ractno',r_idtype = '$b_idtype',r_transfer = '$tmode',r_bank = '$bank' 
    ...
    <th width="797" height="479" scope="row"><div align="center">
      <form id="form1" name="form1" method="post" action="">
        <table width="743" height="873" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <th height="23" colspan="6" scope="row"><span class="style10">
              <?php 
include "info.php";
		...
		echo strtoupper ($s_phone);} ?>
          ...
          <tr>
            ...
            <td class="style10" style="font-size: 14px"><div align="left" class="style12"> <span class="style7">&pound; </span>
              ...
              .00 </div></td>
            <td colspan="4" class="style10" style="font-size: 14px"><p align="left"><span class="style12">TODAY'S RATE: &pound;1= &#8358;
          ...
          <tr>
            ...
            <th height="37" colspan="5" scope="row"><div align="right"><a href="agent_page.php" class="style14">Return to agent home page</a></div></th>
          </tr>
        </table>
      </form>
    </div></th>
