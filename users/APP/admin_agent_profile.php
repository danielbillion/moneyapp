          ...
          <th width="599" height="479" scope="row"><div align="center">
            <table width="584" height="635" border="0" cellpadding="0" cellspacing="0">
              <tr bgcolor="#9933CC">
                ...
                <th bgcolor="#CCCCCC" scope="row"><a href="admin_page.php" class="style18">Return to administration home page</a></th>
              </tr>
              <tr>
              ...
              <tr>
                <th colspan="5" scope="row"><div align="right" class="style8">
                    <div align="center"><span class="style23">Agent <span class="style24">Profile:</span> <?PHP  if (isset($_GET['fname']))
              ...
              <tr>
                ...
                <td width="104" class="style10">&nbsp;</td>
                <td width="88" class="style10">&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                <th scope="row"><div align="left" class="style22">Date Of Birth</div></th>
...
echo "
<em><a href='agent_proofad_download.php? agent_em=$agent_em '> download</a></em>";
...
echo "
<em><a href='agent_proofid_download.php? agent_em=$agent_em '> download</a></em>";
