...
<caption><EM><?php if (isset($_GET['c_name'])) echo strtoupper($_GET['c_name']); ?> 
@<?php if (isset($_GET['fname'])) echo ucfirst($_GET['fname'])." " .ucfirst($_GET['lname']) ; ?>Receiver Profile</EM>
</caption>
...
$c_email = ($_GET['c_ag_email']); // Set email variable
...
echo "</td><td align='left'>";echo "<strong><a href='agent_cust_transaction.php?r_fname=$r_fname  & r_lname=$r_lname & r_phone=$r_phone & r_transfer=$r_transfer & r_pbank=$r_pbank & r_idtype=$r_idtype & c_email=$c_email & c_name=$c_name'> $r_fname </a></strong>";
...
echo "</td><td align='left'>";echo "<strong><a href='agent_cust_transaction.php?r_fname=$r_fname & r_lname=$r_lname & r_phone=$r_phone & r_transfer=$r_transfer & r_abank=$r_abank & r_actno=$r_actno & c_email=$c_email & c_name=$c_name'> $r_fname </a></strong>";
